...
import com.tistory.amyyzzin.dividend.model.constants.Month;
...
public class YahooFinanceScraper implements Scraper{
    ...
    private static final long START_TIME = 86400; //60*60*24 = 1day
    ...
    public ScrapedResult scrap(Company company) {
        ...
        try {
            ...
            Element tbody = tableEle.children().get(1); //table에서 tBody 부분
